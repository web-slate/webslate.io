...
1. Big O is a member of a family of notations invented by <ExternalLink url="https://en.wikipedia.org/wiki/Paul_Gustav_Heinrich_Bachmann">Paul Bachmann</ExternalLink> son of Johann Friedrich Bachmann (1799-1876) and a Lutheran minister (teachings of Jesus Christ and was founded by <ExternalLink url="https://en.wikipedia.org/wiki/Martin_Luther">Martin Luther</ExternalLink>),
...
1. Most efficient sorts are an example of this, such as merge sort. but it is O(n log n) and search such as Binary Search.

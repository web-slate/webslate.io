...
Single Character is palindromic string.

## <AnchorLink label="History" name />
1. Palindrome comes from ancient greek
1. <ExternalLink url="https://en.wikipedia.org/wiki/Sator_Square">Sator Square</ExternalLink> is one of the famous piece which is two dimensional
...
## <AnchorLink label="Longest Palindromic Substring" name />
